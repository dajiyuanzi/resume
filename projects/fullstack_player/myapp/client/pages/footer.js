...
const isIPhone = new RegExp('\\biPhone\\b|\\biPod\\b', 'i').test(window.navigator.userAgent); //检测用户是否用手机访问
let maskProps;
if (isIPhone) {
  maskProps = {
...
class Footer extends Component {
  ...
  //暂停播放：通过判断目前是否处于播放状态来实现音乐的暂停或重新播放的功能。
  toggleStatus() {
  ...
  canPlaySong() { //加载页面时判断是否可播放,可以则播放
    let myaudio = document.getElementById('audioPlay');
    myaudio.play();
  }
